...
class LaunchBarView:
    def __init__(self,
        ...
        self.selected_wad_name = root.findChild(QtWidgets.QLabel, 'launchbar_selected_wad')
        ...
        launch_wad_button = root.findChild(QtWidgets.QPushButton, 'launchbar_launch_button')
